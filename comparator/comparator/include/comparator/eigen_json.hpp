...
template<>
struct adl_serializer<Sophus::SE3d>
{
  static void to_json(json & j, const Sophus::SE3d & value)
  {
    j = value.matrix();
  }

  static void from_json(const json & j, Sophus::SE3d & value)
  {
    Eigen::Matrix4d data = j.get<Eigen::Matrix4d>();
    value = Sophus::SE3d{data};
  }
};
